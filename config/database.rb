...
database_name = case Padrino.env
  when :development then 'hbx_documents_development'
  when :production  then 'hbx_documents_production'
  when :test        then 'hbx_documents_test'
end
...
#     sessions:
#       default:
#         database: hbx_documents_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: hbx_documents_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: hbx_documents_test
#         hosts:
#           - localhost:27017
#
#
